...
set :scm, :git
set :repository,  "git@github.com:allanRoberto/gessoilumi.git" 
# set :scm, :subversion
...
set :local_path, "/Users/Allan/sites/gesso-ilumi" 
...
set :local_domain, 'gessoilumi.art.com.br' 
